...
void upload4()
{
	...
	const char* ptr8 = " D A T A - 2  U P L O A D E D ";
...
void uploading4()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr8 = " U P L O A D I N G  D A T A - 2 ...";
...
void download4()
{
	...
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "D A T A - 1   D O W N L O A D E D";
...
void downloading4()
{
	...
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "D O W N L O A D I N G   D A T A - 1 ...";
...
void download3()
{
	...
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "D A T A - 2    D O W N L O A D E D";
...
void downloading3()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "D O W N L O A D I N G   D A T A - 2 ...";
...
void upload3()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr8 = " D A T A - 1   U P L O A D E D ";
...
void uploading3()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "U P L O A D I N G   D A T A - 1 ...";
...
void download2()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "D O W N L O A D E D ";
...
void downloading2()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "D O W N L O A D I N G ...";
...
void upload2()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "U P L O A D E D ";
...
void uploading2()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr6 = "U P L O A D I N G ...";
...
void downloading()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr5 = "D O W N L O A D I N G ... ";
...
void request()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr3 = "H A N D S H A K E   P R O C E S S";
...
void response()
{
	glPushMatrix();
	glTranslatef(100.0, 0.0, 0.0);
	const char* ptr4 = "H A N D S H A K E   P R O C E S S ";
...
void main(int argc, char** argv)
{
	...
	glutCreateWindow(" CLIENT AND SERVER ");
	Init();
